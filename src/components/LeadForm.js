  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .send(
        ...
        process.env.REACT_APP_EMAILJS_TEMPLATE_ID_NEW, // Access template ID from env
        emailData, // Form data
  ...
  if (formSubmitted) {
    return (
      <div className="thank-you-message">
        <h1>Merci!</h1>
        <p>
          Votre soumission a bien été reçue. Vous allez être redirigé sous peu.
        </p>
      </div>
    );
  }
      ...
      <form onSubmit={sendEmail}>
        ...
        <div className="form-group">
          <label htmlFor="company">
            Centre, clinique, hôpital:<span style={{ color: "red" }}>*</span>
          </label>
          <input
            type="text"
            name="company"
        ...
        <div className="form-group">
          ...
          <div className="product-selection">
            ...
            <button
              ...
              //   className={`product-item ${formData.productInterest.includes('Product 1') ? 'selected' : ''}`}
              className={`product-item ${
                formData.productInterest.includes("identitovigilence")
                  ? "selected"
                  : ""
              }`}
            ...
            <button
              ...
              //   className={`product-item ${formData.productInterest.includes('Product 1') ? 'selected' : ''}`}
              className={`product-item ${
                formData.productInterest.includes("milieux de culture")
                  ? "selected"
                  : ""
              }`}
            ...
            <button
              ...
              className={`product-item ${
                formData.productInterest.includes("Microscopie")
                  ? "selected"
                  : ""
              }`}
        ...
        <p className="consent-text">
          By clicking "Submit," I agree to the collection and processing of my
          personal data in accordance with Caring IVF's Privacy Policy. I also
          consent to receive marketing communications from Caring IVF.
        </p>
      </form>
    </div>
  );
